...
def download_hf_file(dl_path: Union[str, None]=None,
    ...
    except (OSError, TypeError, HTTPError): return None

def process_tcga_slide(path_download: Union[str, None]=None,
                       sam_name: Union[str, None]=None,
    ...
    try:
        ...
        return {"project": project_name, "slide": sam_name,
