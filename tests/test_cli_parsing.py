...
def test_train_cli(mock_train_index):
    ...
    mock_train_index.assert_called_once_with(
        "fake/repo", "test.index", 100, 8, 8, 0.1, 50, 5, 10, 2, None, True, None, None)
...
def test_train_cli_none_params(mock_train_index):
    ...
    mock_train_index.assert_called_once_with(
        "fake/repo", "test.index", 100, 8, 8, None, None, None, None, 2, None, True, None, None)
...
def test_train_cli_main(mock_train_index):
    ...
    main()
    mock_train_index.assert_called_once_with(
        "fake/repo", "test.index", 64, 8, 4, 0.1, 10, 2, 5, 2, None, True, None, None)
...
def test_train_cli_main_none_params(mock_train_index):
    ...
    main()
    mock_train_index.assert_called_once_with(
        "fake/repo", "test.index", 64, 8, 4, None, None, None, None, 2, None, True, None, None)
...
def test_add_cli(mock_add_index):
    ...
    mock_add_index.assert_called_once_with(
        ...
        "test.parquet", 0.1, 50, 5, 10, 2, None, True, None, None)
...
def test_add_cli_none_params(mock_add_index):
    ...
    mock_add_index.assert_called_once_with(
        "fake/repo", "test.index", "test_out.index",
        "test.parquet", None, None, None, None, 2, None, True, None, None)
...
def test_add_cli_main(mock_add_index):
    ...
    mock_add_index.assert_called_once_with(
        "fake/repo", "test.index", "test_out.index",
        "test.parquet", 0.1, 10, 2, 5, 2, None, True, None, None)
